package com.abhishek.springjdbctemplate.config;
...
@EnableJpaRepositories(
        ...
        basePackages = {"com.abhishek.springjdbctemplate.repository"})
public class ApplicationDatabaseConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(
        ...
        return builder
                ...
                .packages("com.abhishek.springjdbctemplate.repository")
